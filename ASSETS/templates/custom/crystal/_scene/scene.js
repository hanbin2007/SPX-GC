/* ==========================================================================
   CRYSTAL · Scene runtime (same runtime as Newsline, own namespace)
   --------------------------------------------------------------------------
   ...
   · Scene            – state shared by every graphic of the package on air. Each
...
(function () {
  ...
  function parse(raw) {
    ...
    catch (err) { console.error("[crystal] invalid data from SPX", err, raw); return {}; }
  }
  ...
  const carryKey = `crystal:carry:${scope}:${layer}`;
